...
export const Banner = (props: ImageProps): JSX.Element => {
  ...
  return (
    <div className="w-full min-h-screen" id={id ? id : undefined}>
      <div className="w-full min-h-screen" style={backgroundStyle}>
...
export const DefaultImage = (props: ImageProps): JSX.Element => {
  const { sitecoreContext } = useSitecoreContext();
