...
try {
    ...
    & $mkcert -install
    & $mkcert "*.jss_nextjs_tpe.localhost"
...
Add-HostsEntry "cm.jss_nextjs_tpe.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.jss_nextjs_tpe.localhost"
}
Add-HostsEntry "id.jss_nextjs_tpe.localhost"
Add-HostsEntry "www.jss_nextjs_tpe.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.jss_nextjs_tpe.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.jss_nextjs_tpe.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.jss_nextjs_tpe.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.jss_nextjs_tpe.localhost"
