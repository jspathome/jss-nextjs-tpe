...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.jss_nextjs_tpe.localhost/ --auth https://id.jss_nextjs_tpe.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.jss_nextjs_tpe.localhost/ --auth https://id.jss_nextjs_tpe.localhost/ --allow-write true
}
...
Start-Process https://cm.jss_nextjs_tpe.localhost/sitecore/
Start-Process https://www.jss_nextjs_tpe.localhost/
